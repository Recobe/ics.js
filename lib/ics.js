//     ics.js 0.0.1  
//     https://github.com/Recobe/ics.js 
...
(function() {
  ...
  // DESCRIPTION -> Kommentar anpassen -> Implementation of the `SUMMARY` property defined in [section 3.8.1.12](https://tools.ietf.org/html/rfc5545#section-3.8.1.12).
  iCalendar.properties.Description = function(value) {
    iCalendar.properties.Base.call(this, 'DESCRIPTION', value);
  };

  iCalendar.properties.Description.prototype = Object.create(iCalendar.properties.Base.prototype);
  iCalendar.properties.Description.prototype.constructor = iCalendar.properties.Base;

  iCalendar.properties.Description.prototype.validateValue = function(value) {
    expectValueType(value, iCalendar.dataTypes.Text);
    return value;
  };
  ...
  iCalendar.Calendar.prototype.changeTitle = function(title) {
	    // TODO: Validate.
	    this.title = title;
	  };
  ...
  iCalendar.Calendar.prototype.toString = function() {
    ...
    output += 'VERSION:2.0' + '\n';
    // TODO: VALID FPI ?
    output += 'PRODID:-//recobe/ics.js//NONSGML ics.js//EN' + '\n';
  ...
  iCalendar.EventBuilder.prototype.setDescription = function(text) {
	    this.event.addProperty(
	      new iCalendar.properties.Description(
	        new iCalendar.dataTypes.Text(text)
	      )
	    );
	  };
  ...
  iCalendar.CalendarBuilder.prototype.setTitle = function(text) {
	    this.calendar.changeTitle(text);
  };  
